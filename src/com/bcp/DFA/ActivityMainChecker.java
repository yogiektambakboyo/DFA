...
public class ActivityMainChecker extends Activity {
    //DB Handler
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        BtnSubmit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if((InputPassword.getText().toString().length()>0)||((InputUsername.getText().toString().length())>0)){
                    ...
                    PassInput=InputPassword.getText().toString();
                    if(netStatus.getConnectivityStatusString(getApplicationContext())!=0){
                        new CekLogin(ActivityMainChecker.this).execute();
                    }else{
        ...
        dbmst.CekCheckerMaster();
        dbmst.CekCheckerApproved();
        db.close();
        dbmst.close();
...
/*            case R.id.action_update:
    ...
    public class UpdateMaster extends AsyncTask<Void, Integer, Void> {
        ...
        protected Void doInBackground(Void... arg0) {
            ...
            try {
                ...
                if(StatusRequest.equals("1")){
                    ...
                    dbmst.DeleteAllCheckerApproved();
        ...
        protected void onPostExecute(Void result) {
            ...
            if(StatusRequest.equals("1")){
                ...
                Intent in = new Intent(getApplicationContext(), ActivityMainMenuChecker.class);
    ...
    public class CekLogin extends AsyncTask<Void, Integer, Void> {
        ...
        @Override
        protected Void doInBackground(Void... arg0) {
            String url = "http://"+Web+"/ws/loginchecker.php?sopir="+UserInput+"&securecode="+getPref(TAG_DEVICEID)+"&pass="+PassInput;
        ...
        protected void onPostExecute(Void result) {
            ...
            if(StatusRequest.equals("1")){
                if (LastLogin.equals("0")){
                    ...
                    new UpdateMaster(ActivityMainChecker.this).execute();
                }
            }else{
                Toast.makeText(getApplicationContext(),"Login Gagal",Toast.LENGTH_SHORT).show();
            }
                ...
                public void onClick(DialogInterface dialog, int which) {
                    switch (which){
                        case DialogInterface.BUTTON_POSITIVE:
                            ActivityMainChecker.this.finish();
                            break;
